 ...
 * App Widget Configuration implemented in {@link WeatherWidget2ConfigureActivity WeatherWidget2ConfigureActivity}
 */
public class WeatherWidget2 extends AppWidgetProvider {
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            WeatherWidget2ConfigureActivity.deleteTitlePref(context, appWidgetId);
        }
    }
